...
function WeChat(){	
	...
	$(".span7").attr("class","span7");
	$(".span2").attr("class","span1");
	$(".maincontent").append("<div class=\"span4\"><legend>微信消息</legend><form id=\"form\"><div id=\"wechats\"></div><div id = \"page\"></div></form><div class=\"pagination\"></div></div>");
	$(".span4").append("<button class='btn' onclick='closeSpan()'>关闭面板</button>");
	flag = 1;
	showwechatMsgs();
